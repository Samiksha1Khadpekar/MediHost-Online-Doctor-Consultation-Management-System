...
public class DoctorController {
	...
	public ResponseEntity<String> registerDoctor(@RequestBody DoctorDTO doctorDTO){
		...
		try {
			...
			if(e.getMessage().contains("doctor.UK_jdtgexk368pq6d2yb3neec59d"))
				return new ResponseEntity<String>("Email " + doctorDTO.getEmail() + " is already registered.", HttpStatus.OK);
			else
